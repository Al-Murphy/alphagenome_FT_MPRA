...
def main():
    ...
    parser.add_argument('--wandb_name', type=str, default="bs256-1024-do05-noWD")
    parser.add_argument('--no_wandb', action='store_true')
    
    # Model parameters
    parser.add_argument('--nl_size', type=str, default='1024', help='Hidden layer sizes: single int or comma-separated list')
