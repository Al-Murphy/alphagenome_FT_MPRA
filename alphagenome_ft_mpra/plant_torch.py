...
# These are pure numpy — they live in the torch-free plant_starrseq_utils so the
# JAX-only NTv3 runner can use them without importing torch. Re-exported here for
# the PyTorch runners that already import from this module.
from .plant_starrseq_utils import (  # noqa: E402,F401
    ridge_fit,
    ridge_predict,
    pearson,
    select_ridge,
